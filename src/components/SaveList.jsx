...
export default function SaveList({ listName, saveList }) {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left mt-1 ">
            <div>
                <Menu.Button className="btn-primary inline-flex justify-center rounded-md border border-gray-300 bg-white px-1 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100">
                        ...
                        <div className="pt-1">
                            <Menu.Item>
                                <input
                                    type="submit"
                                    value="Save"
                                    className="w-full hover:bg-gray-100 hover:text-gray-900 text-gray-700 block px-4 py-2 text-sm text-left my-0 border-t"
                                />
                            </Menu.Item>
                        </div>
                    </form>
